  ...
  return {
    ...
    build: {
      ...
      extendWebpack(cfg) {
        ...
        cfg.externals = [
          //we are using @iy4u/common-utils which has urlParser that uses dns,
          // a module webpack can't resolve for the client
          'dns', // added here so webpack won't worry about it when doing the build
        ];
      },
    },
