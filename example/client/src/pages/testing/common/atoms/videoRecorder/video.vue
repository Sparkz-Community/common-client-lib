...
<script>
  ...
  export default /*#__PURE__*/ {
    ...
    computed: {
      ...
      audioInputSelect() {
        return document.querySelector('#audioSource');
      },
      audioOutputSelect() {
        return document.querySelector('#audioOutput');
      },
      videoSelect() {
        return document.querySelector('#videoSource');
      },
      selectors() {
    ...
    methods: {
      ...
      testAudioInputAccess() {
        let constraints = { video: false, audio: { echoCancellation: true } };
        if (this.resolution) {
          constraints.video = {};
          constraints.video.height = this.resolution.height;
          constraints.video.width = this.resolution.width;
      ...
      listFromVideoInput(cameras) {
        cameras = {...cameras, ...this.videoInputHeader};
        let staticOptions = {...this.staticVideoOptions, ...this.staticVideoOptionsHeader};
        if (this.isBrowserScreenShareable && cameras.length > 0) {
          return [
        ...
        } else if (this.isBrowserScreenShareable && cameras.length === 0) {
