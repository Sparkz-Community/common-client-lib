...
export default async (
  ...
  class IntegrationAuths extends BaseModel {
  ...
  IntegrationAuths.modelName = 'IntegrationAuths';

  IntegrationAuths.diffOnPatch = function (data) {
    // console.log('diffOnPatch data', data);
    if (data['_id']) {
      const originalObject = IntegrationAuths.store.state['integration-auths'].keyedById[data['_id']];
