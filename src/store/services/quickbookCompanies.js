...
export default async (
  ...
  QuickbooksCompanies.modelName = 'QuickbooksCompanies';

  QuickbooksCompanies.diffOnPatch = function (data) {
    // console.log('diffOnPatch data', data);
    if (data['_id']) {
      const originalObject = QuickbooksCompanies.store.state['quickbooks/companies'].keyedById[data['_id']];
